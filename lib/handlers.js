                                                                ...
                                                                _data.delete('users', dataQueryStringObjectPhone, function(error){
                                                                    ...
                                                                    // Continue if [error] is null and [userObject] is deleted
                                                                        if(!error){
                                                                            ...
                                                                            // Delete each [checkObject] that is associeated with [userObject]
                                                                                ...
                                                                                // Validate that [userObjectChecks] key is defined in [userObject] and that it is an instance of an araray, if so save array as [checks] or set to empty array
                                                                                    ...
                                                                                    ;
                                                                                // Validate that [userObjectChecks] key is defined in [userObject] and that it is an instance of an araray, if so save array as [checks] or set to empty array
                                                                                // Select number of [checksToDelete]
                                                                                    var checksToDelete = userObjectChecks.length; 
                                                                                // Select number of [checksToDelete]
                                                                                // Continue if [checksToDelete.length] is greater than zero
                                                                                    if(checksToDelete > 0){

                                                                                        // Define and set [checksDeleted] to zero
                                                                                            var checksDeleted = 0;
                                                                                        // Define and set [checksDeleted] to zero
                                                                                        // Define and set [deletionErrors] to false
                                                                                            var deletionErrors = false;
                                                                                        // Define and set [deletionErrors] to false
                                                                                        // ((LOOP)) through the [userObjectChecks]
                                                                                            userObjectChecks.forEach(function(checkId){
                                                                                               
                                                                                                // Delete [checkObject]
                                                                                                    _data.delete('checks', checkId, function(error){

                                                                                                        // Continue if number of [checksDeleted] is increased 
                                                                                                            ...
                                                                                                            // Continue if [error]
                                                                                                            // Continue whether [error] is set to true or false
                                                                                                                checksDeleted++;
                                                                                                            // Continue whether [error] is set to true or false
                                                                                                            // Continue once [checksDeleted] is equal to [checksToDelete]
                                                                                                                if(checksDeleted == checksToDelete){

                                                                                                                    // Continue if [deletionErrors] is set to false
                                                                                                                        if(!deletionErrors){
                                                                                                                            callback(200, {'message' : 'Successfully deleted the user with phone number ' +dataQueryStringObjectPhone+ ' and deleted their ' +checksDeleted+ ' checks'});
                                                                                                                        }else{
                                                                                                                            callback(500, {'error' : 'Errors encountered while attempting to delete all of the [userObjectChecks]. All of the [checkObjects] may have not been deleted from the system successfully.'});
                                                                                                                        }
                                                                                                                    // Continue if [deletionErrors] is set to false
                                                                                        ...
                                                                                        callback(200, {'message' : 'User with phone number ' +dataQueryStringObjectPhone+ ' was deleted, but ' +deletionErrors+ 'deletion errors occurred'});
                                                                                    }
                                                                                // Continue if [checksToDelete.length] is greater than zero 
