            ...
            // Container for [handlers._tokens] private [method]s
                ...
                // [handlers._tokens.post]
                    ...
                    handlers._tokens.post = function(data, callback){
                        ...
                        // Validate all required fields
                        // Continue if [phone] and data payload [password] are valid
                            if(phone && password){
                                    ...
                                    _data.read('users', phone, function(error, userObject){
                                        ...
                                        // Continue if [error] is null and [userObject] is defined
                                            if(!error && userObject){
                                                ...
                                                // [hash] the sent data payload [password]
                                                    var hashedPassword = helpers.hash(password);
                                                // [hash] the sent data payload [password]
                                                // Continue if data payload [password] matches the saved [userObject.hashedPassword]
                        ...
                        // Continue if [phone] and [password] are valid
